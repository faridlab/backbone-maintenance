//! Database seeder binary for module: maintenance
//!
//! Generated by metaphor-schema. Do not edit manually.
//!
//! Run with: cargo run --bin maintenance-seeder
//! Or via CLI: backbone seed run --module maintenance
//!
...
async fn main() -> Result<()> {
    ...
    println!();
    println!("Running seeders for module: maintenance");
    println!();
