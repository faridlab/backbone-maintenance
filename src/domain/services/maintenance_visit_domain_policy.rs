//! Domain policy for MaintenanceVisit aggregate
//!
...
/// Domain policy for MaintenanceVisit — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<MaintenanceVisit>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type MaintenanceVisitDomainPolicy = PermitAllPolicy<MaintenanceVisit>;
