//! Domain policy for MaintenanceStage aggregate
//!
...
/// Domain policy for MaintenanceStage — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<MaintenanceStage>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type MaintenanceStageDomainPolicy = PermitAllPolicy<MaintenanceStage>;
