//! Specifications for MaintenanceVisit aggregate
//!
...
// Each predicate implements `Specification<MaintenanceVisit>` and can be combined
...
//
// pub struct ActiveMaintenanceVisitSpec;
// impl Specification<MaintenanceVisit> for ActiveMaintenanceVisitSpec {
//     fn is_satisfied_by(&self, e: &MaintenanceVisit) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
