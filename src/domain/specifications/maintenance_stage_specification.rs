//! Specifications for MaintenanceStage aggregate
//!
...
// Each predicate implements `Specification<MaintenanceStage>` and can be combined
...
//
// pub struct ActiveMaintenanceStageSpec;
// impl Specification<MaintenanceStage> for ActiveMaintenanceStageSpec {
//     fn is_satisfied_by(&self, e: &MaintenanceStage) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
