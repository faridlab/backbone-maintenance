//! Specifications for MaintenanceSchedule aggregate
//!
...
// Each predicate implements `Specification<MaintenanceSchedule>` and can be combined
...
//
// pub struct ActiveMaintenanceScheduleSpec;
// impl Specification<MaintenanceSchedule> for ActiveMaintenanceScheduleSpec {
//     fn is_satisfied_by(&self, e: &MaintenanceSchedule) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
