//! Specifications for MaintenanceVisitPart aggregate
//!
...
// Each predicate implements `Specification<MaintenanceVisitPart>` and can be combined
...
//
// pub struct ActiveMaintenanceVisitPartSpec;
// impl Specification<MaintenanceVisitPart> for ActiveMaintenanceVisitPartSpec {
//     fn is_satisfied_by(&self, e: &MaintenanceVisitPart) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
