...
/// Create stateless routes for the Maintenance module.
///
...
///
/// ```ignore
/// let module = MaintenanceModule::builder().with_database(pool).build()?;
/// let routes = create_stateless_routes(&module);
/// let app = Router::new().merge(routes);
/// ```
pub fn create_stateless_routes(module: &crate::MaintenanceModule) -> Router<()> {
    Router::new()
...
pub fn get_routes(module: &crate::MaintenanceModule) -> Router<()> {
    Router::new()
...
/// Create stateful routes for the Maintenance module.
///
...
pub fn create_combined_routes(module: &crate::MaintenanceModule) -> Router<AppState> {
...
/// Get all routes (stateful) for the Maintenance module.
///
/// This is a convenience function that wraps routes with API versioning.
pub fn get_routes_with_state(module: &crate::MaintenanceModule) -> Router<AppState> {
    Router::new()
